...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Mức đo nhịp tim " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
// Phần popup khi bạn nhấn vào nút "Nhịp tim "
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Đo thử nhé:';
document.querySelector('.Description .modal-body').innerHTML = 'SINH NHẬT VUI VẺ NHÉ <i class="fas fa-heart"></i> ';
